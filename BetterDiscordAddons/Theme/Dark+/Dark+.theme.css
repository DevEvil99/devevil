...
.container-YkUktl .button-12Fmur:nth-child(3) .contents-3ca1mk path {
  fill: var(--darkplus-sec);
}
...
.cozyMessage-1DWF9U .contents-2MsGLg > .markup-eYLPri:not(:empty, code) {
  background-color: var(--darkplus-bg2);
...
.modeUnread-3Cxepe .icon-2W8DHg, .modeUnread-3Cxepe .name-28HaxV, .modeSelected-3DmyhH .icon-2W8DHg, .modeSelected-3DmyhH:hover .icon-2W8DHg, .modeUnread-3Cxepe .icon-2W8DHg, .modeUnread-3Cxepe:hover .icon-2W8DHg, .modeConnected-NrO4cP .name-28HaxV, .modeConnected-NrO4cP:hover .name-28HaxV, .modeSelected-3DmyhH .name-28HaxV, .modeSelected-3DmyhH:hover .name-28HaxV, .modeUnread-3Cxepe .name-28HaxV, .modeUnread-3Cxepe:hover .name-28HaxV {
  color: var(--darkplus-links);
}
...
.item-1OdjEX, .icon-Lupfh-, .userTagDiscriminatorNoNickname-2HLaIE {
  color: var(--darkplus-sec);
}

.usernameContainer-3PPkWq, .activityText-1rR-8O, .activity-icon {
  color: var(--darkplus-sec);
}
...
.headerText-10ez_d, .sidebar-nqHbhN .side-1lrxIh .item-2GWPIy, .bd-sidebar-header h2 {
  color: var(--darkplus-sec);
}
